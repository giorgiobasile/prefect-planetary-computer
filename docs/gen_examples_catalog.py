...
import prefect_planetary_computer

COLLECTION_SLUG = "prefect_planetary_computer"
...
for _, module_name, ispkg in iter_modules(prefect_planetary_computer.__path__):
